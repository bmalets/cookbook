...
RSpec.describe 'API V1 Recipe Searches Answers' do
  describe 'GET /api/v1/recipe_searches/:id/answer' do
    subject(:make_request) do
      get "/api/v1/recipe_searches/#{recipe_search.id}/answer",
    ...
    context 'when the recipe search exists' do
      ...
      it 'returns the recipe search answer data' do
